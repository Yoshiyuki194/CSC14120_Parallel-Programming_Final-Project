...
int main(int argc, char* argv[])
{
    ...
    if (use_gpu) {
        ...
        Network gpu_dnn;
        Layer *gpu_conv1 = new Conv_gpu(1, 28, 28, 6, 5, 5, 1, 0, 0, n_streams, version);
        Layer *gpu_pool1 = new MaxPooling(6, 24, 24, 2, 2, 2);
        Layer *gpu_conv2 = new Conv_gpu(6, 12, 12, 16, 5, 5, 1, 0, 0, n_streams, version);
